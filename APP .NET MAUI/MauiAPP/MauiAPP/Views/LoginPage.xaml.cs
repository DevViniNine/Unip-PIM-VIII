...
public partial class LoginPage : ContentPage
{
    ...
    // EU RECUPERAR O TOKEN EM QUALQUER LUGAR COM  :  var token = Preferences.Get("jwt_token", null);

    // QUANDO USUARIO DESLOGAR POSSO REMOVER O TOKEM COM : Preferences.Remove("jwt_token");
